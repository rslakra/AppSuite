package com.rslakra.core.bos.automobile;

/**
 * Vehicle means a land motor vehicle with four wheels that is designed for use on public roads and intended for use on
