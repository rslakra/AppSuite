...
public class FilePersistence extends AbstractPersistence {
	...
	public static final String ROOT_OBJECT_MAP_NULLER_TRACE = "rootObjectMap nuller trace";
	public static final String UNDEFINED_ROOT_OBJECT_MAP = "undefined root object map";
	public static final String FILE_PERSISTENCE_CREATION_FAILED = "file persistence creation failed";
	public static final String CAN_NOT_RE_OPEN_CLOSE_PENDING = "can not re-open, close pending";
	public static final String CAN_NOT_CLOSE_AGAIN_CLOSE_PENDING = "can not close again, close pending";
	public static final String FAILED_CANCEL_OBJECTS_MODIFICATION = "failed cancel objects modification";
	public static final String FAILED_SAVE_OBJECTS = "failed save objects";
	public static final String SESSION_NOT_OPENNED = "session is not openned";
	public static final String SESSION_ALREADY_OPENNED = "session already openned";
	public static final String FAILED_SET_ROOT_OBJECT = "failed set root object";
