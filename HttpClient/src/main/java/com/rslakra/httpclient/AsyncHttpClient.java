        ...
        Supplier<CompletionStage<HttpResponse>> supplier = () -> {
            ...
            httpAsyncClient.execute(ofApacheRequest(request), new FutureCallback<HttpResponse>() {
                ...
                public void failed(Exception ex) {
                    ...
                    LOGGER.error("failed() - execute async http client for name=%s", getClientName(), ex);
                ...
                public void cancelled() {
                    ...
                    LOGGER.error("cancelled() - execute async http client call cancelled for name=%s", getClientName());
