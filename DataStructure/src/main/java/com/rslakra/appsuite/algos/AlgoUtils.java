...
import com.rslakra.appsuite.algos.list.ListNode;
import com.rslakra.appsuite.algos.time.Interval;
...
//    }
    ...
    public static void print2DIntArray(int[][] values) {
    ...
    public static List<Integer> randomIntArrayGenerator(int size) {
        return randomIntArrayGenerator(size, UPPER_BOUND);
    }

    // overloaded method to take no argument
    public static List<Integer> randomIntArrayGenerator() {
        return randomIntArrayGenerator(TREE_SIZE, UPPER_BOUND);
    }
    ...
    /**
     * If you want to print the reversed list out, you need to return the reversed list's head, which was the end node
     * of the original node. using the following function.
     */
