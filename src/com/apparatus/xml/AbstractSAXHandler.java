 ...
 * 
 */
public abstract class AbstractSAXHandler extends DefaultHandler implements DefaultXmlTags {
	
	/** <code>serialVersionUID</code> */
	private static final long serialVersionUID = -679343913809072841L;
	
	/** logger */
	private static final Logger logger = LogManager.getLogger(AbstractSAXHandler.class);
	 ...
	 * @param attributes
	 */
	protected abstract void startElementPost(String uri, String localName, String qName, Attributes attributes);
	 ...
	 * @return
	 */
	protected abstract boolean endElementPre(String uri, String name, String qName);
