 ...
 * commands to the Web browser, and only works for applets running in the
...
public class HTMLWriter extends Writer {
	 ...
	 * window to display the output in. You must specify the applet (this
	 * specifies the main browser window) and the desired size for the new
	 * window.
	 **/
	...
	/**
	 * This is the write() method required for all Writer subclasses. Writer
	 * defines all its other write() methods in terms of this one.
	 **/
	 ...
	 * <P>
	 * tag or some other HTML tag that forces a line break in the output.
	 **/
	public void flush() {
	}
	
	/**
	 * When the stream is closed, close the JavaScript Document object (But
	...
	/**
	 * If the browser window is still open, close it. This method is unique to
	 * HTMLWriter.
	 **/
	 ...
	 * writes them out to an HTMLWriter stream. It will only work in Netscape
	 * 4.0 or later. It requires an <APPLET> tag like this: <APPLET
	 * CODE="HTMLWriter$Test.class" WIDTH=10 HEIGHT=10 MAYSCRIPT>
	 * <PARAM NAME="url" VALUE="HTMLWriter.java"> </APPLET> Note that MAYSCRIPT
	 * attribute. It is required to enable the applet to invoke JavaScript.
	 **/
