 ...
 * 
 * The reproduction, transmission or use of this code or its contents is not
 * permitted without prior express written consent of Devamatre Technologies.
 ...
 * 
 * Devamatre Technologies reserves the right to modify technical specifications
 * and features without any further notifications.
 * 
 ...
 * 
 * See license.txt for more details about the allowed use of this software.
 **************************************************************************/

package com.devamatre.core.lang;

import com.devamatre.core.utils.StringUtil;
...
public final class NumberConvert
{
	...
	private final String[] tens = { " ", "eleven", "twelve", "thirteen",
			"fourteen", "fifteen", "sixteen", "seventeen", "eighteen",
			"nineteen" };
	private final String[] hundreds = { " ", "ten", "twenty", "thirty",
			"fourty", "fifty", "sixty", "seventy", "eighty", "ninety" };
	
	private final static String[] denomination = { "", "thousand", "million",
	...
	public String numbersToWords(int num)
	{
		...
		if (num > 0)
		{
			...
			{
				str += hundreds[ctr] + threesConverter(num % 1000)
						+ hundreds[ctr];
	...
	public String ConvertNumberToString(int num)
	{
		...
		for (int i = 1; i <= length; i++)
		{
			...
			{ // if more than four digit number is given then executed
				value = (int) num / 1000;
			...
			if (count == 2)
			{ // if count is 2 then the number is at Tens place
				switch (value)
				{
					case 1:
						if (num == 11)
			...
			else
			{
				...
				{ // if a fourth postion number is
					// processed
					// then add
					result = result + " Thousand";
				}
				else if (count == 3)
				{ // if a third position number is
					// processed
					// then add
...
//		nConvert.setCapatilize(true);
	...
	{
		static String[] to_19 = { "zero", "one", "two", "three", "four",
		...
		public String english_number(int val)
				throws Exception
		{
			if (val < 100)
			{
