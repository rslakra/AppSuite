 ...
 * It is important to note that port numbers between 0 and 1023 are reserved. 
 * If you run HttpsServer on a different port number, 
 * the url should be: https://localhost:portnumber but if you run it on 443 
...
//   private static String keystore = "lakra/net/serverCert";
   ...
   //have given them in a method.
   	...
   	public ServerSocket getServer() throws Exception {
		...
		ssFactory.createServerSocket(HTTPS_PORT);
   		return serversocket;
